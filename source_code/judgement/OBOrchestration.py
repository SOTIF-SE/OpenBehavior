...
def generate_trace(scene, gen, idx):
    try:
        ...
        bashCommand = f"conda run -n scen python ../openbehavior_runner.py --sync --waitForEgo --GA True --openbehavior ../Openbehavior_Osc/obehavior_s4.osc\
    ...
    file = "/home/abc/scenario_runner/trace/obehavior_s4/trace_obehavior_s4_{}_{}.json".format(gen + 1, idx)
