...
class ScenarioManager(object):
    ...
    def send_routing_request_apollo(self, waypoints = []):
        ...
        data_temp_file = "/home/abc/scenario_runner_able_edition/ego_info/ego_des.json"
        des = {
            "x": end_location.x,
            "y": end_location.y,
            "z": end_location.z
        }
        with open(data_temp_file, 'w') as outfile:
    ...
    def run_scenario(self):
        ...
        world = CarlaDataProvider.get_world()
        recorder = CameraRecorder(world, self.ego_vehicles[0])
        recorder.start()
