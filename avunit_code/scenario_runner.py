...
def load_template(path="/home/abc/scenario_runner_able_edition/scenario_record/avunit_s4_extra_time.json"):
    with open(path, "r") as f:
        return json.load(f)


def save_result(scene, path="/home/abc/scenario_runner_able_edition/scenario_record/avunit_s4_extra_time.json"):
...
class ScenarioRunner(object):
    ...
    def _load_and_run_scenario(self, config):
        ...
        try:
            ...
            if os.path.exists("/home/abc/scenario_runner_able_edition/scenario_record/avunit_s4_extra_time.json"):
