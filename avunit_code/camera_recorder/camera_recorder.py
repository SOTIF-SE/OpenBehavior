...
class CameraRecorder(object):
    def __init__(self, world, ego_vehicle, path=None):
        self.world = world
        ...
        self.camera = None
        self.fileidx = 0
        while os.path.exists("/home/abc/scenario_runner_able_edition/Law_Judgement/traffic_accident_video/accident_{}.avi".format(self.fileidx)):
            self.fileidx += 1
    ...
    def camera_callback(self, image):
        ...
        if self.video_writer is None:
            ...
            self.video_writer = cv2.VideoWriter(
                "traffic_accident_video/accident_{}.avi".format(self.fileidx),
