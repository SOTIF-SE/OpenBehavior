...
Carla_Python_Path = "/home/xie/Carla/PythonAPI/carla/agents:/home/xie/Carla/PythonAPI/carla"
...
def start_pro():
    ...
    container = client.containers.get("apollo_dev_xie")
    ...
    _, output = container.exec_run(cmd, user='xie',
                                   stdin=True,
                                   stream=True,
