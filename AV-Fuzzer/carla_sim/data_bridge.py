...
class DataBridge(object):
    ...
    def end_trace(self, path) -> None:
        ...
        fileidx = 0
        while os.path.exists(path +'/{}.json'.format(fileidx)):
            fileidx += 1
        with open(path +'/{}.json'.format(fileidx), 'w', encoding='utf-8') as fw:
            json.dump(self.trace, fw, indent=4)

        # with open(path + scenario +'/{}_{}.json'.format(filetype, scenario), 'w', encoding='utf-8') as fw:
        #     json.dump(self.trace, fw, indent=4)
    ...
    def update_trace(self) -> None:
        ...
        qx, qy, qz, qw = euler_orientation(ego_transform.rotation)
