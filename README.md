...
By integrating heterogeneous NPC behavior models, OpenBehavior enables complex multi-policy interactions that are difficult to construct manually.  
In this example, a learning-based NPC decelerates, while a rule-based vehicle performs a lane change.  
The interaction between these heterogeneous behaviors leads to an unexpected prediction failures in Apollo’s prediction module, ultimately resulting in a collision.
